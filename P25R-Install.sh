...
sudo sed -i '/^\[/h;G;/\[Log/s/\(FilePath=\).*/\1'"\/var\/log\/pi-star"'/m;P;d' ./P25Reflector.ini
sudo sed -i '/^\[/h;G;/\[Id Lookup/s/\(Name=\).*/\1'"\/usr\/local\/etc\/DMRIds.dat"'/m;P;d' ./P25Refector.ini
